...
NtpReply::NtpReply(const NtpReply &other)
    : d(other.d)
{
}
...
NtpClient::NtpClient(const QHostAddress &bindAddress, quint16 bindPort, QObject *parent)
    : QObject(parent)
{
